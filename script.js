...
const addTransactionIntoDOM = ({amount, name, id}) => {
    ...
    li.innerHTML = 
        ...
        <button class="delete-btn" onClick = "removeTransection(${id})"> x</button>`
...
const addToTransactionsArray = (transectionName, transactionAmount) => {
    transactions.push({
        id: generateID(),
        name: transectionName, 
...
const handleFormSubmit = event => {
    ...
    const transectionName = inputTransactionName.value.trim()
    const transactionAmount = inputTransactionAmount.value.trim()
    const IsSomeInputEmpty = transectionName === '' || transactionAmount === ''
    ...
    addToTransactionsArray(transectionName, transactionAmount) 
    init()
    updateLocalStorage()
    cleanInputs()
